...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return ((float64(CaloriesWeightMultiplier)*w.Weight + (math.Pow((w.meanSpeed()*KmHInMsec), 2)/(w.Height/100))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * float64(MinInHours))
}
